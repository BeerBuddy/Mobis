 ...
 */
public class DeclineFriendInvitationRequest extends SpringAndroidSpiceRequest<Void> {

    private final FriendInvitation person;
    public DeclineFriendInvitationRequest(FriendInvitation person) {
        super(Void.class);
        this.person = person;
    }
    ...
    public Void loadDataFromNetwork() throws Exception {
        getRestTemplate().postForObject(ServerUtil.getHost()+"/friendinvitation/decline", person, Void.class, Collections.EMPTY_MAP);
        return null;
    }
